...
<div class="easyui-window" title="tsm登录" data-options="modal:true,closable:false,collapsible:false,minimizable:false,maximizable:false" style="width: 400px;height: 280px;padding: 10px">
	...
	<form id="fm" action="" method="post">
		<table cellpadding="6px" align="center">
			...
			<tr>
				<td>密码：</td>
				<td>
					<input type="password" id="userpwd" name="userpwd" class="easyui-validatebox" required="true" style="width: 200px"/>
				</td>
			</tr>
			<%-- <tr>
				<td>角色：</td>
